...
group_by()
summarize()
count() (combines group_by and summarizes sample size)
pull() (to create a vector out of values in a column)
t.test()
cohen.d() (for effect size)
levenTest() (tests for equal variances)
geom_beeswarm
geom_point()
geom_errorbar()
aov() (one-way ANOVA)
TukeyHSD()
lm()
ANOVA() (can specify what type of ANOVA you want to run)
